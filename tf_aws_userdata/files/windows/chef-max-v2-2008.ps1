...
$TagFilter1 = ((New-Object Amazon.EC2.Model.Filter).WithName("resource-id").WithValue($InstanceId))
$TagFilter2 = ((New-Object Amazon.EC2.Model.Filter).WithName("key").WithValue("Name"))
...
####### get chef-max.ps1 to run subsequent chef-client runs.
